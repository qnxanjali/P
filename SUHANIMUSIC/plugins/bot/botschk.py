...
from SUHANIMUSIC.core.userbot import *
...
async def bots_chk(_, message):
    msg = await message.reply_photo(photo="https://envs.sh/qii.jpg", caption="**ᴄʜᴇᴄᴋɪɴɢ ʙᴏᴛs sᴛᴀᴛs ᴀʟɪᴠᴇ ᴏʀ ᴅᴇᴀᴅ...**")
